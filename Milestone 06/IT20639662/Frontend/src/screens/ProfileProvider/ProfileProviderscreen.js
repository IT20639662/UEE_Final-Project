...
import LogTypeImg from  "../../../assets/images/user.png";
  ...
  return (
    ...
    <View style={Styles.root}>
      ...
      <View style={Styles.card}>
        <Text style={Styles.txt}>LKJS Solutions</Text>
      </View>

      <Text style={Styles.profText}>Email Address</Text>
      <View style={Styles.card}>
        <Text style={Styles.txt}>lksj@gmail.com</Text>
      </View>

      <Text style={Styles.profText}>Phone Number</Text>
      <View style={Styles.card}>
        <Text style={Styles.txt}>011 6789876</Text>
      </View>

      <Text style={Styles.profText}>Password</Text>
      <View style={Styles.card}>
        <Text style={Styles.txt}>lksj#123</Text>
      </View>

      <Text style={Styles.profText}>Address</Text>
      <View style={Styles.card}>
        <Text style={Styles.txt}>Colombo</Text>
      </View>

      <Text style={Styles.profText}>Description</Text>
      <View style={Styles.card1}>
        <Text style={Styles.txt}>LKSJ Solutions is the best.....</Text>
      </View>
